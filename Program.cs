    ...
    static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            if (result.ToUpper().Contains("INVALID")){
                File.AppendAllText("ErrorsDuringRun.log", $"{DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}✅{args[0]}✅{result}✅{allLines[0].Replace(Environment.NewLine,String.Empty)}{Environment.NewLine}");
            }
